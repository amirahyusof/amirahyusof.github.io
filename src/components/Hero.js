...
function Hero(){
    return(
        <div className="h-full-screen text-[#65451F]">
            <img src={landscape} className="mx-auto justify-center rounded-xl mt-[-150px] w-full md:w-[900px] h-[300px]" /> 
            ...
            <div className="px-4 sm:w-[550px] md:w-[850px] my-10 mx-auto justify-center">
                ...
                Most recently, I've been building static website with React and serverless providers like Firebase and Netlify.</p>
                <br></br>
                <p className='text-xl'>Currently, I'm interested in learning more into PHP and MySQL, documentation and also web app. 
