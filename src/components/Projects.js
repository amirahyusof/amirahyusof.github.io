...
function Project(){
    return(
        <div className="h-full-screen text-[#65451F]" id="projects">
            <img src={iconSection} className="mx-auto justify-center mt-[-150px] w-full md:w-[900px] h-[300px]" />
                        ...
                        <div className="text-center">
                            <div className="flex justify-end my-4">
                                <a href="https://github.com/amirahyusof/coffee-website" 
                                   className="hover:text-[#65451F]" target="_blank"><FiGithub size={20} /></a>
                                <a href="https://amirahyusof.github.io/coffee-website/" 
                                   target="_blank" className="hover:text-[#65451F]"><FaLink size={20} /></a>
                            </div>
                            <h2 className="text-lg">EspressoVista</h2>
                            <div className="text-center justify-center flex mt-8 text-[#65451F]">
                        ...
                        <div className="text-center">
                            <div className="flex justify-end my-4">
                                <a href="" 
                                   className="hover:text-[#65451F]" target="_blank"><FiGithub size={20} /></a>
                                <a href="" 
                                   className=" hover:text-[#65451F]" target="_blank"><FaLink size={20} /></a>
                            </div>
                        ...
                        <div className="text-center">
                            <div className="flex justify-end my-4">
                                <a href="https://github.com/amirahyusof/tracking_job-application" 
                                   className="mr-4 hover:text-[#65451F]" target="_blank"><FiGithub size={20} /></a>
                                <a href="" 
                                   className="hover:text-[#65451F]" target="_blank"><FaLink size={20} /></a>
                            </div>
